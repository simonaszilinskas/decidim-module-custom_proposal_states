    ...
    module Admin
      class ProposalStatesController < Admin::ApplicationController
        ...
        def new
          ...
          @form = form(ProposalStateForm).instance
        end
        ...
        def edit
          enforce_permission_to(:update, :proposal_state, proposal_state: proposal_state)
          @form = form(ProposalStateForm).from_model(proposal_state)
        end
        ...
        def destroy
          enforce_permission_to(:destroy, :proposal_state, proposal_state: proposal_state)
