...
describe "Manage proposal wizard steps help texts", type: :system do
  ...
  let!(:proposal) { create(:extended_proposal, component: current_component, users: [user]) }
  let!(:proposal_similar) { create(:extended_proposal, component: current_component, title: "This proposal is to ensure a similar exists") }
  ...
  it "customize the help text for step 2 of the proposal wizard" do
    ...
    create(:extended_proposal, title: "More sidewalks and less roads", body: "Cities need more people, not more cars", component: component, users: [user])
    create(:extended_proposal, title: "More trees and parks", body: "Green is always better", component: component, users: [user])
    visit_component
  ...
  it "customize the help text for step 4 of the proposal wizard" do
    ...
    visit preview_proposal_path(current_component, create(:extended_proposal, :draft, component: current_component, title: "This proposal has a similar", users: [user]))
    within ".proposal_wizard_help_text" do
